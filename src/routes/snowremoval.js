  ...
  return (
    <section className="service-page">
      <head>
        ...
        <meta name="description" content="24/7 EMERGENCY SERVICE, 
        Driveways, parking lots, service roads, walkways, All property types,
        On-site based crew, if needed,
        Salting, Salt purchase option"/>
      </head>
